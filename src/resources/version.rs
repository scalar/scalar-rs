...
impl VersionResource {
    ...
    pub fn retrieve(
        ...
        RetrieveRequestBuilder::new(self.client.clone(), namespace.into(), slug.into(), semver.into())
    }
    ...
    pub fn delete(
        ...
        DeleteRequestBuilder::new(self.client.clone(), namespace.into(), slug.into(), semver.into())
    }
    ...
    pub fn create(
        ...
        namespace: impl Into<String>,
        slug: impl Into<String>,
        body: crate::models::VersionCreateBody,
