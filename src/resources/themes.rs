...
impl ThemesResource {
    ...
    /// Create a theme
    pub fn create(&self, body: crate::models::ThemesCreateBody) -> CreateRequestBuilder {
        CreateRequestBuilder::new(self.client.clone(), body)
    }

    /// Update theme metadata
    pub fn update(&self, slug: impl Into<String>, body: crate::models::ThemesUpdateBody) -> UpdateRequestBuilder {
        UpdateRequestBuilder::new(self.client.clone(), slug.into(), body)
    }
    ...
    ) -> ReplaceDocumentRequestBuilder {
        ReplaceDocumentRequestBuilder::new(self.client.clone(), slug.into(), body)
    }

    /// Delete a theme
    pub fn delete(&self, slug: impl Into<String>) -> DeleteRequestBuilder {
        DeleteRequestBuilder::new(self.client.clone(), slug.into())
    }

    /// Get a theme
    pub fn retrieve(&self, slug: impl Into<String>) -> RetrieveRequestBuilder {
        RetrieveRequestBuilder::new(self.client.clone(), slug.into())
    }
}
...
#[must_use = "a request builder does nothing until `.send().await` is called"]
pub struct ReplaceDocumentRequestBuilder {
    client: crate::client::Scalar,
    slug: String,
    body: crate::models::ThemesReplaceDocumentBody,
    idempotency_key: Option<String>,
...
impl ReplaceDocumentRequestBuilder {
