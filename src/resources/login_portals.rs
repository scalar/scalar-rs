...
/// Login Portals
#[derive(Clone)]
pub struct LoginPortalsResource {
    client: crate::client::Scalar,
}

impl LoginPortalsResource {
    ...
    pub fn update(&self, slug: impl Into<String>, body: crate::models::LoginPortalsUpdateBody) -> UpdateRequestBuilder {
    ...
    /// Create a portal
    pub fn create(&self, body: crate::models::LoginPortalsCreateBody) -> CreateRequestBuilder {
